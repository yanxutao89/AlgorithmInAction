...
public class CompareStringsByFrequencyOfTheSmallestCharacter {
	...
	/**
	 * Runtime: 20 ms, faster than 40.94% of Java online submissions for Compare Strings by Frequency of the Smallest Character.
	 * Memory Usage: 40.2 MB, less than 25.65% of Java online submissions for Compare Strings by Frequency of the Smallest Character.
	 * @param queries
	 * @param words
	 * @return
	 */
