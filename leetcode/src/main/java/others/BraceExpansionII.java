...
public class BraceExpansionII {
	...
	/*
	 * Runtime: 10 ms, faster than 59.74% of Java online submissions for Brace Expansion II.
	 * Memory Usage: 37.3 MB, less than 100.00% of Java online submissions for Brace Expansion II.
	 */
